# Streaming LLM Response Support for Alga Agent
...
```
ALGA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ALGA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `alga_cli/config.py` | 1 | +streaming config defaults |
