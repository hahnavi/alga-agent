#!/usr/bin/env python3
"""
SWE Runner with Alga Trajectory Format

A runner that uses Alga-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Alga-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Alga-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Alga format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Alga-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Alga-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Alga Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Alga-Agent's built-in execution environments
    and outputs trajectories in Alga-Agent format.
    """
    ...
    def _convert_to_alga_format(
        ...
        """
        Convert internal message format to Alga trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Alga trajectory format
        trajectory = self._convert_to_alga_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Alga trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Alga Trajectory Format")
    print("=" * 60)
