...
def auth_json_path():
    """Return the Alga auth store path, respecting ALGA_HOME overrides."""
    return get_alga_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`alga tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from alga_cli.auth import resolve_nous_access_token
