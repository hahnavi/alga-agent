...
Trust levels:
  - builtin:   Ships with Alga. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.alga/\.env|\~/\.alga/\.env',
     "alga_env_access", "critical", "exfiltration",
     "directly references Alga secrets file"),
    ...
    (r'\.alga/config\.yaml|\.alga/SOUL\.md',
     "alga_config_mod", "critical", "persistence",
     "references Alga configuration files directly"),
...
# scan. `.skillignore` is the Alga-native name; `.clawhubignore` is honored
