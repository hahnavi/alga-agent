...
the get_anchored_view / get_messages_around primitives in alga_state.
...
# Third-party integrations tag their sessions with ALGA_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from alga_state import DEFAULT_DB_PATH
