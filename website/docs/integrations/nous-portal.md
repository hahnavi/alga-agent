...
The Portal's own [model info page](https://portal.nousresearch.com/info) carries the same warning, so this isn't a Alga-side opinion — it's the official guidance from Nous Research.
