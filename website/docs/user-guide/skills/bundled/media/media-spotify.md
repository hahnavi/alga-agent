...
Control the user's Spotify account via the Alga Spotify toolset (7 tools). Setup guide: https://alga-agent.hahnavi.my.id/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `alga auth spotify` again.
