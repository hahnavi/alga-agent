...
| Version | `1.1.0` |
| Author | Alga Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Alga:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Alga tools to understand the project:
