...
```python
import sys
sys.path.insert(0, "/home/teknium/.alga/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.alga/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Alga installs package this)
