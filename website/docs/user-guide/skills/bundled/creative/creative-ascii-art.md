...
```bash
python3 -m pyfiglet "ALGA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ALGA&font=Slant" | boxes -d stone
```
