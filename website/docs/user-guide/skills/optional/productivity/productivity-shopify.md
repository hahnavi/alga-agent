...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Alga","productType":"Apparel","tags":["test"]}}'
```
