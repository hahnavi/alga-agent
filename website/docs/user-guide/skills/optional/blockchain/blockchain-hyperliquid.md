...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Alga Agent |
| License | MIT |
...
The script reads `~/.alga/.env` for two optional defaults:
...
Helper script: `~/.alga/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.alga/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.alga/.env`.
...
```bash
python3 ~/.alga/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.alga/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
