...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Alga Agent |
| License | MIT |
...
```
SCRIPT=~/.alga/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.alga/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
