...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/research/qmd` |
...
Alga Agent via the native MCP client. This is the preferred
...
Then configure Alga Agent to connect via HTTP:
