...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Alga Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ALGA_OSINT_CACHE/icij/ (default: ~/.cache/alga-osint/icij/).
...
# Set ALGA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
