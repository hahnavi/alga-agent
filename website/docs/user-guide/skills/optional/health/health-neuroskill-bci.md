...
| | |
|---|---|
| Source | Optional — install with `alga skills install official/health/neuroskill-bci` |
...
Connect Alga to a running [NeuroSkill](https://neuroskill.com/) instance to read
