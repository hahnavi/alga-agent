...
slug: /
sidebar_position: 0
title: "Alga Agent Documentation"
description: "The self-improving AI agent for Alga, forked from Alga's Hermes Agent. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent for Alga, forked from [Alga's Hermes Agent](https://github.com/Alga/hermes-agent). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/hahnavi/alga-agent/releases/latest" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>Download Desktop</a>
  <a href="https://github.com/hahnavi/alga-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `alga setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Alga safely |
| 🧭 **[Use MCP with Alga](/guides/use-mcp-with-alga)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Alga](/guides/use-voice-mode-with-alga)** | Hands-on setup and usage patterns for Alga voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Alga' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Alga |
...
- **Built by model trainers** — Created by [Alga](https://nousresearch.com), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Alga](https://nousresearch.com) — the lab behind Hermes, Nomos, and Psyche models
