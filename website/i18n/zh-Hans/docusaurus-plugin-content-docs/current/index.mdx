...
sidebar_position: 0
title: "Alga Agent 文档"
description: "用于 Alga 的自我改进 AI 智能体，分叉自 Nous Research 的 Hermes Agent。内置学习循环，从经验中创建技能，在使用过程中持续改进，并跨会话保持记忆。"
...
用于 Alga 的自我改进 AI 智能体，分叉自 [Nous Research 的 Hermes Agent](https://github.com/NousResearch/hermes-agent)。唯一内置学习循环的智能体——它从经验中创建技能，在使用过程中持续改进，主动提示自身持久化知识，并在会话间不断深化对你的建模。
