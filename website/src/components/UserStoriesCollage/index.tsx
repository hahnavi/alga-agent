  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Alga Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Alga &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Alga?{' '}
        <a
          href="https://github.com/hahnavi/alga-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Alga" target="_blank" rel="noopener noreferrer">
          Alga Discord
        </a>{' '}
