...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-alga-agent',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/software-development/software-development-alga-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-alga-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-alga-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-alga',
        'guides/use-soul-with-alga',
        'guides/use-voice-mode-with-alga',
        'guides/build-a-alga-plugin',
