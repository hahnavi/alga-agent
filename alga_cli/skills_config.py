"""
Skills configuration for Alga Agent.
`alga skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.alga/config.yaml under:
...
from alga_cli.config import cfg_get, load_config, save_config
from alga_cli.colors import Colors, color
from alga_cli.platforms import PLATFORMS as _PLATFORMS
