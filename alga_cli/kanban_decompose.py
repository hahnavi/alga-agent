...
Invoked by ``alga kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Alga Agent board.
...
def _profile_author() -> str:
    """Mirror of ``alga_cli.kanban._profile_author``."""
    return (
