...
import type { ScrollBoxHandle } from '@alga/ink'
import { evictInkCaches } from '@alga/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ALGA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
