...
description: Use when a Alga Kanban worker wants to run Codex CLI as an isolated implementation lane while Alga keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Alga Agent
license: MIT
metadata:
  alga:
    ...
    related_skills: [kanban-worker, codex, alga-agent]
---
