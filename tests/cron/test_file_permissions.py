...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("alga_cli.config.get_config_path", return_value=config_path), \
             patch("alga_cli.config.ensure_alga_home"):
    ...
    def test_ensure_alga_home_sets_0700(self):
        home = Path(self.tmpdir) / ".alga"
        with patch("alga_cli.config.get_alga_home", return_value=home):
