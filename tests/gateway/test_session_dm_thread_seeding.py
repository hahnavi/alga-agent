...
def store(tmp_path, monkeypatch):
    ...
    ~/.alga/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at alga_state import time, before pytest's ALGA_HOME monkeypatch
    fires — the autouse fixture's ALGA_HOME override doesn't help here.)
    """
    import alga_state
