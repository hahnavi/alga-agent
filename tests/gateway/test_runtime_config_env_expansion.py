...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("ALGA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("ALGA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    monkeypatch.delenv("ALGA_GATEWAY_BUSY_INPUT_MODE", raising=False)
    monkeypatch.delenv("ALGA_RESTART_DRAIN_TIMEOUT", raising=False)
    monkeypatch.delenv("ALGA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
