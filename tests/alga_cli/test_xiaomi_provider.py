...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from alga_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ALGA_OVERLAYS
        overlay = ALGA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify alga doctor recognizes Xiaomi env vars."""
