"""Tests for `alga curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import alga_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ALGA_HOME with real agent-created skills on disk."""
    home = tmp_path / ".alga"
    skills = home / "skills"
    ...
    from alga_cli import curator as curator_cli
