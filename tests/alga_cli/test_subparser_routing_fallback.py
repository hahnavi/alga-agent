...
The main() function in alga_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `alga -c model`
...
def _build_parser():
    """Build a minimal replica of the alga top-level parser."""
