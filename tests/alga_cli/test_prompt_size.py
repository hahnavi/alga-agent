"""Tests for the ``alga prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from alga_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(alga_home, memory_text="", user_text=""):
    mem_dir = alga_home / "memories"
...
def _seed_skill(alga_home, name, description):
    skill_dir = alga_home / "skills" / "demo" / name
