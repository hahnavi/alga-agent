"""Tests for the interactive session browser (`alga sessions browse`).
...
from alga_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """alga sessions browse should be parseable."""
