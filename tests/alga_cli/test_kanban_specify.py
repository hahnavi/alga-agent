"""Tests for the specifier module + `alga kanban specify` CLI surface.
...
from alga_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `alga kanban …` argparse surface directly."""
