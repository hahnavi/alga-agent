...
The unit tests in tests/alga_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned alga-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/alga")
from alga_cli.service_manager import S6ServiceManager
