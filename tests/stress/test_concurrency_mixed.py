...
def worker_loop(worker_id: int, alga_home: str, result_file: str) -> None:
...
def reclaimer_loop(alga_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="alga_mixed_stress_")
    print(f"ALGA_HOME = {home}")
