...
def test_import_loads_env_from_alga_home(tmp_path, monkeypatch):
    home = tmp_path / ".alga"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-alga-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-alga-home"
