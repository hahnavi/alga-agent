#!/usr/bin/env python3
"""Build the Alga Model Catalog — a centralized JSON manifest of curated models.
...
Alga CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Alga release.
...
# Ensure ALGA_HOME is set for imports that touch it at module level.
os.environ.setdefault("ALGA_HOME", os.path.join(os.path.expanduser("~"), ".alga"))

from alga_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "alga-agent repo",
            "docs": "https://alga-agent.hahnavi.my.id/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
