#!/usr/bin/env python3
"""Build the Alga Skills Index — a centralized JSON catalog of all skills.
...
`alga skills search/install` can use it without hitting the GitHub API.
...
# Ensure ALGA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Alga Skills Index...", flush=True)
