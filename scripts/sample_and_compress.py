...
DEFAULT_DATASETS = [
    ...
    "hahnavi/alga-agent-megascience-sft1",
    "hahnavi/alga-agent-Thinking-GLM-4.7-SFT2",
    "hahnavi/alga-agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-alga-agent"
]
