...
def _profile_user_agent() -> str:
    """Return a ``alga-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from alga_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"alga-cli/{_ver}"
    except Exception:
        return "alga-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # alga-cli UA so the catalog endpoint is reachable.
